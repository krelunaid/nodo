import { STYLES } from "@/lib/trading/risk";
...
export function Rules() {
  return (
    <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <Rule
        kicker="4 · Rischio"
        title="Stop sulla candela, target 2R"
        body={`Stop sotto il minimo (o sopra il massimo) della candela di segnale. Take profit almeno il doppio del rischio. ${STYLES.intraday.settings.maxPositions} idee insieme in intraday, mai correlate.`}
      />
    </section>
  );
}
